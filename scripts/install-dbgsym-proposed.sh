...
#
# This is the same as install-dbgsym.sh, but it also enables support for
# release-proposed. This way any patches pushed can be tested with it's new ddeb
# to keep the versions together.
...
function add_dbgsym_repo() {
  ...
  echo "Info: Running proposed script, so will add proposed repository."
